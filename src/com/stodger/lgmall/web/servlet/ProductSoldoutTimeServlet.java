...
/**
 * @author lenovo
 * @version 创建时间：2019年1月9日  下午1:38:19
 */
@WebServlet("/productSoldoutTime")
public class ProductSoldoutTimeServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		boolean result = productService.productSoldoutTime(pid);
